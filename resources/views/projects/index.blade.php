        ...
        <tbody>
            @foreach($projects as $project)
                <tr>
                    ...
                    <td class="text-center"><a href="{{route("types.show", $project->type->id)}}" class="badge bg-primary text-decoration-none text-white rounded-pill px-3 py-2">{{$project->type->name}}</a></td>
